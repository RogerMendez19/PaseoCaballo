...
{  
  ...
  int ciclos = 0;                             
  int intentos_fallidos = 0; // Esta variable cuenta cuantos ciclos se intetan antes de obtener el que pidio el usuario.
  ...
  { 
    ...
    int Arreglo[][] = new int[tamano + 1][tamano +1];// de 9x9 para evitar el 0
    ...
    System.out.print("\n¿Cuantas casillas quiere que recorra el caballo?: ");
    ...
    System.out.printf("Se intentaron %d ciclos antes de obtener el requerido.\n", intentos_fallidos); 
    Imprime( Arreglo );
  }  
